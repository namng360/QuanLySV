package vn.mac.gnam.quanlysv.helpers;
...
public class InputValidation {
     ...
     * @return
     */
    private static final String USERNAME_PATTERN = "^[a-zA-Z\\.\\'\\-]{2,50}(?: [a-zA-Z\\.\\'\\-]{2,50})+$";//"^[A-Za-z\\s\\w]{5,15}$";
//^[a-zA-Z\.\'\-]{2,50}(?: [a-zA-Z\.\'\-]{2,50})+$
    public boolean isValidUsername(EditText textInputEditText, TextInputLayout textInputLayout, String message) {
    ...
    public boolean isInputEditTextEmail(EditText textInputEditText, TextInputLayout textInputLayout, String message) {
        String EMAIL_PATTERN =
                "^[A-Za-z]+[_A-Za-z0-9-]{1,}+(\\.[_A-Za-z0-9-]+)*@([A-Za-z0-9](.*[a-z].*))+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$";
